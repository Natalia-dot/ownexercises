...
export const introduction = [
    ...
    img: <img src='https://previews.123rf.com/images/vadymvdrobot/vadymvdrobot1703/vadymvdrobot170307024/75590828-vertical-image-of-man-in-striped-sweater-and-glasses-posing-with-arms-in-pockets-and-looking-at.jpg'/>
 },
  {
...
export const workPageInfo = {
  ...
  technologies:
<>
  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/JavaScript-logo.png/768px-JavaScript-logo.png" alt='Javascript logo'/>
  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Node.js_logo.svg/2560px-Node.js_logo.svg.png" alt='Node logo'/>
  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/CSS.3.svg/800px-CSS.3.svg.png" alt='CSS3 logo'/>
  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/HTML5_Badge.svg/800px-HTML5_Badge.svg.png" alt='HTML5 logo'/>
  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/React-icon.svg/2300px-React-icon.svg.png" alt='React logo'/>
  <img src="https://www.styled-components.com/atom.png" alt='Styled components logo'/>
  <img src="https://coursera-university-assets.s3.amazonaws.com/05/353594a7964fdeaff4e10615de58c0/MongoDBSquareLogo.png" alt='MongoDB logo'/>
</>,
  projects:
//aqui en vez de fragments habia flexdiv pero no los reconoce
  ...
  otherLanguages: <>
  <h2>I can speak:</h2>
  <img src="https://upload.wikimedia.org/wikipedia/en/thumb/9/9a/Flag_of_Spain.svg/1200px-Flag_of_Spain.svg.png" alt='Flag of Spain'/>
  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Flag_of_the_United_Kingdom_%281-2%29.svg/1200px-Flag_of_the_United_Kingdom_%281-2%29.svg.png" alt='Flag of United Kingdom'/>
  <img src="https://upload.wikimedia.org/wikipedia/en/thumb/c/c3/Flag_of_France.svg/800px-Flag_of_France.svg.png" alt='Flag of France'/>
